...
class Sky extends StatefulWidget {
  ...
  const Sky({required this.color, required this.mode, required this.weatherMode});
}
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return Stack(
          ...
          children: <Widget>[
            ...
            CustomPaint(painter: SkyPainter(constraints.maxHeight * 0.3, this._thunder, widget.color, thunder)),
