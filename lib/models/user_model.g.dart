...
class UserModelAdapter extends TypeAdapter<UserModel> {
  ...
  UserModel read(BinaryReader reader) {
    ...
    return UserModel(
      ...
      challangerLife: (fields[2] as num).toInt(),
      bestChallengerScore: (fields[3] as num).toInt(),
      bestTimerScore: (fields[4] as num).toInt(),
      bestComboScore: (fields[5] as num).toInt(),
      level: (fields[6] as num).toInt(),
      exp: (fields[7] as num).toDouble(),
      expMultiplier: (fields[8] as num).toDouble(),
