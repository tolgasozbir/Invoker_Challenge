...
enum Spells {
  ...
  emp             (combine: 'www', cooldown: 30, mana: 125, damage: 375, duration: 0),  //375
  tornado         (combine: 'wwq', cooldown: 24, mana: 150, damage: 360, duration: 0),  //360
  alacrity        (combine: 'wwe', cooldown: 17, mana: 100, damage: 72,  duration: 8),  //576
  deafening_blast (combine: 'qwe', cooldown: 40, mana: 300, damage: 640, duration: 0),  //640
